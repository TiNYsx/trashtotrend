...
export const dict = {
  ...
  scanCheckpoint: { en: "Scan Checkpoint", th: "สแกนจุดเช็คอิน" },
  scanBooth: { en: "Scan Booth", th: "สแกนบูธ" },
  scanCustomerQR: { en: "Scan customer QR codes to mark checkpoint completion", th: "สแกน QR Code ลูกค้าเพื่อบันทึกการเข้าบูธ" },
  selectCheckpoint: { en: "Select a checkpoint", th: "เลือกจุดเช็คอิน" },
  selectBooth: { en: "Select a booth", th: "เลือกบูธ" },
